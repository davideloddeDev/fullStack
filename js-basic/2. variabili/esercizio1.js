...
// Utilizziamo "let" per dichiarare variabili che potrebbero cambiare nel tempo.
let carMake = "Toyota"; // Marca dell'auto
let carModel = "Corolla"; // Modello dell'auto
let carYear = 2022; // Anno di produzione dell'auto
let ownerName = "John Doe"; // Nome del proprietario dell'auto

// Utilizziamo "const" per dichiarare variabili che non cambieranno nel tempo.
const isNewCar = true; // Variabile booleana che indica se l'auto è nuova o usata
